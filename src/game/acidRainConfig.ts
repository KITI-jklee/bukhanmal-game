/* 산성비게임 밸런스 상수 — 상세기획서 4-2 ~ 4-7 숫자를 로직에 흩뿌리지 않고 한곳에 모아 밸런스 튜닝(9~10일차)이 이 파일 수정만으로 끝나도록 한다. */
...
/* "게임 오버" 모달을 띄운 뒤 자동으로 결과 화면(닉네임 등록)으로 넘어가기까지 기다리는 시간(초). */
...
// 2026-08-19 밸런스 조정: 게임이 전반적으로 어렵다는 피드백에 따라 시간정지 단어(플레이어에게 유리한 구제 아이템)가 더 자주 나오도록 출현 간격을 줄이고, 스테이지1·2도 스테이지3처럼 반복 출현하게 했다(기존엔 1회뿐).
